...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/403', component: () => import('@/views/ForbiddenView.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'repair/profile', component: () => import('@/views/student/ProfileView.vue'), meta: { roles: ['repair_staff'] } },
      { path: 'repair/orders', component: () => import('@/views/repair/RepairOrdersView.vue'), meta: { roles: ['repair_staff'] } },
      { path: 'repair/my-orders', component: () => import('@/views/repair/RepairOrdersView.vue'), meta: { roles: ['repair_staff'] } },
      { path: 'cleaning/dashboard', component: () => import('@/views/DashboardView.vue'), meta: { roles: ['cleaning_staff'] } },
      { path: 'cleaning/profile', component: () => import('@/views/student/ProfileView.vue'), meta: { roles: ['cleaning_staff'] } },
      { path: 'cleaning/orders', component: () => import('@/views/cleaning/CleaningOrdersView.vue'), meta: { roles: ['cleaning_staff'] } },
      { path: 'cleaning/my-orders', component: () => import('@/views/cleaning/CleaningOrdersView.vue'), meta: { roles: ['cleaning_staff'] } },
      ...
      { path: 'manager/repairs/all', component: () => import('@/views/manager/RepairReviewView.vue'), meta: { roles: ['dormitory_manager'] } },
      { path: 'manager/cleanings', component: () => import('@/views/manager/CleaningReviewView.vue'), meta: { roles: ['dormitory_manager'] } },
      { path: 'manager/cleanings/all', component: () => import('@/views/manager/CleaningReviewView.vue'), meta: { roles: ['dormitory_manager'] } },
